...
$from = 'Demo contact form <contact@designelit.com>';

// an email address that will receive the email with the output of the form
$sendTo = 'Demo contact form <cbiz@designelit.com>';

// subject of the email
$subject = 'c-Biz Template Email';

// form field names and their translations.
// array variable name => Text to appear in the email
$fields = array('name' => 'Name', 'email' => 'Email', 'phone' => 'Cell Number', 'subject' => 'Subject', 'comment' => 'Message'); 
...
try
{
    ...
    $emailText = "You have a new message from c-Biz Template\n====================================\n";
